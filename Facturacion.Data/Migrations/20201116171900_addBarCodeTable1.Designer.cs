...
namespace Facturacion.Data.Migrations
{
    ...
    [Migration("20201116171900_addBarCodeTable1")]
    partial class addBarCodeTable1
    {
            ...
            modelBuilder.Entity("Facturacion.Domain.Invoices", b =>
                {
                    ...
                    b.HasOne("Facturacion.Domain.BarCode", "BarCode")
                        .WithOne("Invoices")
                        .HasForeignKey("Facturacion.Domain.Invoices", "InvoiceID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
