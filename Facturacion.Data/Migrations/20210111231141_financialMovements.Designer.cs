...
namespace Facturacion.Data.Migrations
{
    ...
    [Migration("20210111231141_financialMovements")]
    partial class financialMovements
    {
            ...
            modelBuilder.Entity("Facturacion.Domain.FinancialMovements", b =>
                {
                    b.HasOne("Facturacion.Domain.FinancialMovementTypes", "Type")
                        .WithOne("FinancialMovements")
                        .HasForeignKey("Facturacion.Domain.FinancialMovements", "TypeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
